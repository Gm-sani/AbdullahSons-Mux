...
export default function Services() {
  ...
  useEffect(() => {
    const cards = gsap.utils.toArray('#servbox1 , #servbox3 , #servbox5 ');
    const cards2 = gsap.utils.toArray(' #servbox2,  #servbox4 ,#servbox6');
  ...
  return (
    ...
    {/* -----------------------------------------Box row 1---------------------------- */}
    <div id='servbox1' className='lg:flex flex-row min-[310px]:mx-[3rem] gap-5 justify-center lg:mt-6 mt-[-10rem] '>
    ...
    {/* -----------------------------------------Box row 2---------------------------- */}
    <div id='servbox2' className='lg:flex flex-row min-[310px]:mx-[3rem] gap-5 justify-center mt-[12rem] '>
    ...
    {/* -----------------------------------------Box row 3---------------------------- */}
    <div id='servbox3' className='lg:flex flex-row min-[310px]:mx-[3rem] gap-5 justify-center mt-[12rem] '>
    ...
    {/* -----------------------------------------Box row 4---------------------------- */}
    <div id='servbox4' className='lg:flex flex-row min-[310px]:mx-[3rem] gap-5 justify-center mt-[12rem] '>
    ...
    {/* -----------------------------------------Box row 5---------------------------- */}
    <div id='servbox5' className='lg:flex flex-row min-[310px]:mx-[3rem] gap-5 justify-center mt-[12rem] '>
     ...
     {/* -----------------------------------------Box row 6---------------------------- */}
     <div id='servbox6' className='lg:flex flex-row min-[310px]:mx-[3rem] gap-5 justify-center mt-[12rem] '>
